...
// 
// Date: Revised by yousf 20160825
// 
//////////////////////////////////////////////////////////////////////////
////-------- Header files
//
#include "../include/rk_mfnr.h"         // MFNR: Multi-Frame Noise Reduction

extern unsigned short  cure_table[24][961];                                  
#if !WDR_WEIGHT_ENABLE                                                                             
unsigned short static weightData[9*256] =                                    
{                                                                            
	#include "../table/weightData.dat"                                          
};                                                                           
#endif                                                                             
...
RK_U16 MotionDetectTable[MOTION_DETECT_TALBE_LEN] = {
...
int classMFNR::Register(void)
{
    ...
    for (int i=0; i < mThumbDivSegRow; i++)
    {
        ...
        FeatureDetect(pThumbDspChunks[chunkIdx], mThumbWid+2, NUM_LINE_DDR2DSP_THUMB+2, mThumbStride+4, i, mThumbDivSegCol, 
            pThumbFilterDspChunk, pWdrWeightMat, pFeaturePoints, pFeatureValues, pWdrThumbWgtTable);
...
#if WDR_WEIGHT_ENABLE                                                                                 
	// add by zxy : filter for full size image                                                           
...
#else
	memcpy(pWdrThumbWgtTable,weightData,9*256*sizeof(RK_U16));
#endif	                                                                                               
