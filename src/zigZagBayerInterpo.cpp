						...
						
{
	...
	uint8_t* pScaleL0G0	= scale 									;                              
	uint8_t* pScaleL0Red  = scale+1									;                              
	uint8_t* pScaleL0Blu	= scale	  + HDR_FILTER_W 	;                              
	uint8_t* pScaleL0G1	= scale+1 + HDR_FILTER_W 	;                              
	uint8_t* pScaleL1G0	= scale   + 2*HDR_FILTER_W ;                              
	uint8_t* pScaleL1Red  = scale+1 + 2*HDR_FILTER_W ;                              
	uint8_t* pScaleL1Blu  = scale   + 3*HDR_FILTER_W ;                              
	uint8_t* pScaleL1G1	= scale+1 + 3*HDR_FILTER_W ;                              
